...
def show_help(stdscr):
    ...
    stdscr.clear()
    stdscr.refresh()
    rectangle(stdscr, mid_x, mid_y, mid_x + 16, mid_y + 40)
    ...
    stdscr.addstr(mid_x + 5, mid_y + 2, "f   -   Filter for a word")
    ...
    stdscr.addstr(mid_x + 15, mid_y + 2, "Home, Page UP, Page Down work also")
    stdscr.refresh()
    stdscr.timeout(-1)
    stdscr.getch()
